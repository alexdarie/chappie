...
\title{Data mining tools for analyzing weather influence over fitness habits\\}
% \thanks{Identify applicable funding agency here. If none, delete this.}
% }

\author{\IEEEauthorblockN{1\textsuperscript{st} Alexandru M. Adascalitei}
\IEEEauthorblockA{\textit{Computer Science} \\
\textit{Babes-Bolyai University}\\
Cluj-Napoca, Romania \\
aaie2251@scs.ubbcluj.ro}
}
...
WITH  
 ...
 FROM 
  `habits`, params
 WHERE
  type = "Run" and distance > 0
  and moving_time > 0 and MOD(
...
\bibitem{a1} Lynette Jones (2009) Thermal touch. Scholarpedia, 4(5):7955., revision \#150165.
\bibitem{a2} Manoveg Saxena (2018) Implementing Multiclass Logistic Regression using BigQuery ML,
\url{https://medium.com/analytics-vidhya/multi-class-logistic-regression-using-bigquery-ml-c4a2c8cddad6}
\bibitem{a3} Lak Lakshmanan (2019) BigQuery ML gets faster by computing a closed-form solution (sometimes),
\url{https://medium.com/google-cloud/bigquery-ml-gets-faster-by-computing-a-closed-form-solution-sometimes-1baa5a838eb6}.
\end{thebibliography}
\vspace{12pt}
