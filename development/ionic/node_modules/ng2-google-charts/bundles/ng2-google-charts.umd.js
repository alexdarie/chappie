    ...
    ***************************************************************************** */
    ...
    var GoogleChartsLoaderService = /** @class */ (function () {
        ...
        GoogleChartsLoaderService.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: ['googleChartsSettings',] }, { type: core.Optional }] }
        ]; };
        GoogleChartsLoaderService.ɵprov = core["ɵɵdefineInjectable"]({ factory: function GoogleChartsLoaderService_Factory() { return new GoogleChartsLoaderService(core["ɵɵinject"](core.LOCALE_ID), core["ɵɵinject"]("googleChartsSettings", 8)); }, token: GoogleChartsLoaderService, providedIn: "root" });
        GoogleChartsLoaderService = __decorate([
            core.Injectable({
                providedIn: 'root'
            }),
            __param(0, core.Inject(core.LOCALE_ID)),
            __param(1, core.Inject('googleChartsSettings')), __param(1, core.Optional())
    ...
    var GoogleChartsDataTable = /** @class */ (function () {
        function GoogleChartsDataTable(opt) {
            this.opt = opt;
            this.dataTableChanged = new core.EventEmitter();
            if (opt) {
    ...
    var GoogleChartComponent = /** @class */ (function () {
        function GoogleChartComponent(el, loaderService) {
            ...
            this.chartSelectOneTime = new core.EventEmitter();
            this.chartReady = new core.EventEmitter();
            this.chartReadyOneTime = new core.EventEmitter();
            this.chartError = new core.EventEmitter();
            this.chartErrorOneTime = new core.EventEmitter();
            this.mouseOver = new core.EventEmitter();
            this.mouseOverOneTime = new core.EventEmitter();
            this.mouseOut = new core.EventEmitter();
            this.mouseOutOneTime = new core.EventEmitter();
            this.regionClick = new core.EventEmitter();
            this.regionClickOneTime = new core.EventEmitter();
        }
        ...
        GoogleChartComponent.prototype.getHTMLTooltip = function () {
            var tooltipER = new core.ElementRef(this.el.nativeElement.querySelector('.google-visualization-tooltip'));
